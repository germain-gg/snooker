import { Ball, FoulValue, RedCount, TotalColouredValues, VisitResult } from ".";
...
export class Frame {
  ...
  /**
   * Starts the Frame, player1 always starts
  ...
  /**
   * Generic function to add one action taken during a frame of snooker
